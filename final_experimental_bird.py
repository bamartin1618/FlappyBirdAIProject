...
pygame.display.set_caption('Flappy AI Final (Experimental)')
...
brain = pickle.load(open(os.path.join(sys.path[0], 'experimental_bird.pkl'), 'rb'))

point_sound = mixer.Sound(os.path.join(sys.path[0], 'FlappyBird/sfx_point.mp3'))
hit_sound = mixer.Sound(os.path.join(sys.path[0], 'FlappyBird/hit.mp3'))
